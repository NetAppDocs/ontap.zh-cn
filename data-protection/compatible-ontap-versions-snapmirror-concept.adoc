...
[NOTE]
====
无法在ONTAP 9.11.1中初始化DP类型的镜像、在未来版本中将完全弃用。有关详细信息，请参见 link:https://mysupport.netapp.com/info/communications/ECMLP2880221.html["已弃用数据保护SnapMirror关系"^]。
