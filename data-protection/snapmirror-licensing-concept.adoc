...
+
如果您的系统是在 2019 年 6 月之前购买的，且包含 Premium 或 Flash Bundle，则可以从 NetApp 支持站点下载 NetApp 许可证密钥以获取所需的 SnapMirror 同步许可证： https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["许可证密钥"^]。
