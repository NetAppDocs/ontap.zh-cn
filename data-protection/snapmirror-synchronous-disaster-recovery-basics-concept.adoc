...
| 自主勒索软件保护 | ONTAP 9.19.1 | 如果在升级后对属于 SnapMirror 同步或 SnapMirror 活动同步关系的卷启用 ARP，则该关系会短暂移至不同步状态。这种情况是暂时的，关系应自动重新同步，无需干预。有关详细信息，请参见 link:../anti-ransomware/use-cases-restrictions-concept.html["自主勒索软件保护使用情形和注意事项"]。 
