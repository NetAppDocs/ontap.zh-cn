...
[NOTE]
====
您可能会发现保留一份命令输出副本以跟踪现有关系设置会很有帮助[`snapmirror show`。有关链接：https://docs ONTAP．ONTAP－SnapMirror-show.html命令的更多信息，请参阅NetApp[`snapmirror show`命令参考。
...
----
+
有关链接：https://docs ONTAP．ONTAP－SnapMirror-quiesce.html命令的更多信息，请参阅NetApp[`snapmirror quiesce`命令参考。
