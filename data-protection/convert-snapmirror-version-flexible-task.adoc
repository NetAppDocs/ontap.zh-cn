...
+
要缩短重新同步时间、您可以使用 `-quick-resync` 选项、但您应注意、存储效率节省可能会丢失。有关完整的命令语法、请参见手册页： link:https://docs.netapp.com/us-en/ontap-cli-9111/snapmirror-resync.html#parameters.html["snapmirror resync命令"]。
