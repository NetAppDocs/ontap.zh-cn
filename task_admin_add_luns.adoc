...
NOTE: 您还可以将这些 LUN 的规范保存到 Ansible Playbook 中。有关更多详细信息，请转到 link:https://docs.netapp.com/us-en/ontap/task_use_ansible_playbooks_add_edit_volumes_luns.html["使用 Ansible 攻略手册添加或编辑卷或 LUN"^]。
