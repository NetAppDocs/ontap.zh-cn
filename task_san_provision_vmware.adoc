...
要使用 System Manager 经典版（适用于 ONTAP 9.7 及更早版本）为 ESXi 主机设置对数据存储库的 SAN 协议访问，请参见以下主题： * https://docs.netapp.com/us-en/ontap-sm-classic/fc-config-windows/index.html["适用于 Windows 的 FC 配置概述"^]*
