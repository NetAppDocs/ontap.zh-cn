...
如下表所示，Trellix 和 Trend Micro 的互操作性详细信息保留在 NetApp 互操作性表中。Trellix、Deep Instinct 和 OPSWAT 的互操作性详细信息也可以在合作伙伴网站上找到。合作伙伴将在其网站上维护 Sentinel One、Symantec、Deep Instinct、OPSWAT 和其他新合作伙伴的互操作性详细信息。
...
* link:https://docs.trellix.com/bundle/endpoint-security-storage-protection-2.3.x-product-guide/page/GUID-58044D4D-91E6-4F1C-892C-605783676063.html["NetApp 在 Trellix ePO - On-prem 托管端点 (trellix.com) 上的配置"^]
...
| Trend Micro | link:https://docs.trendmicro.com/en-us/documentation/article/serverprotect-for-netapp-gsg-aspx-__architecture-cluster-2["集群模式下的产品架构"^] | link:https://imt.netapp.com/matrix/["NetApp 互操作性表工具"^] 


| Sentinel One  a| 
* link:https://www.sentinelone.com/platform/singularity-cloud-data-security/["SentinelOne Singlity Cloud Data Security"^]
* link:https://www.sentinelone.com/resources/datasheets/threat-detection-for-netapp/["针对 NetApp 的威胁检测"^]
