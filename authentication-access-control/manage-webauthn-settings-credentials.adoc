...
NOTE: 如果要从 ONTAP 9.16.1 到 9.18.1 升级到 ONTAP 9.19.1，请参见 link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-Issues/CONTAP-597688["CONTAP-597688"] 以了解更多信息。

[role="tabbed-block"]
====
.System Manager
--
. 选择 *Cluster > Settings > Multifactor authentication (MFA)*。
. 添加、删除或修改允许的 RP 域。
...
.命令行界面
--
. 修改允许的 rp 域。将 -rp-domains 设置为完整集群 FQDN：
+
[source, console]
----
...
----
+
如需了解有关 `security webauthn modify`的更多信息，请参阅link:https://docs.netapp.com/us-en/ontap-cli/security-webauthn-modify.html#parameters["ONTAP 命令参考"^]。
