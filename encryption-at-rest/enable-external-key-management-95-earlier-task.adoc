...
---
= 在ONTAP 9.5 及更早版本中为 NVE 启用外部密钥管理
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: 在MetroCluster环境中，您必须在两个集群上运行此命令。详细了解 `security key-manager setup`在link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-setup.html["ONTAP 命令参考"^]。
...
+
详细了解此过程中描述的命令link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-show-key-store.html["ONTAP 命令参考"^]。
