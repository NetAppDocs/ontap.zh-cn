...
.开始之前
* 您必须是集群管理员才能执行此任务。
* SnapLock link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["必须安装许可证"] 在节点上。中包含此许可证 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"]。
