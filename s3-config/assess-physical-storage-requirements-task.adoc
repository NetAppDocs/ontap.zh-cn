...
.关于此任务
在启用了 S3 的 SVM 中创建 S3 存储区时，FlexGroup 卷link:../s3-config/architecture.html#automatic-flexgroup-sizing-with-ontap-9-14-1-and-later["自动创建"]以支持该存储区。您可以让 ONTAP 自动选择底层聚合和 FlexGroup 组件（默认），也可以自己选择底层聚合和 FlexGroup 组件。
...
* https://www.netapp.com/pdf.html?item=/media/17251-tr4571a.pdf["NetApp 技术报告 4571-A ：《 NetApp ONTAP FlexGroup 卷最佳实践》"^]
