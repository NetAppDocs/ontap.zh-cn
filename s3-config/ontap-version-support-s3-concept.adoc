...
与 FC、iSCSI、NFS、NVMe_oF 和 SMB 等其他协议一样，S3 需要先安装许可证，然后才能在 ONTAP 中使用。S3 许可证是免费的许可证，但必须在升级到 ONTAP 9.8 的系统上安装。S3 许可证可以从 NetApp 支持站点上的 link:https://mysupport.netapp.com/site/systems/master-license-keys/ontaps3["许可证密钥页面"^] 下载。
