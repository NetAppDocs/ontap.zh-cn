...
* 所有负载共享镜像关系
+
有关删除负载分担关系的详细信息，请参见 link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["如何删除负载共享镜像关系"]。
