...
| System Manager 经典版（ ONTAP 9.7 及更早版本） | https://docs.netapp.com/us-en/ontap-sm-classic/nas-multiprotocol-config/index.html["SMB 和 NFS 多协议配置概述"^] 
...
* link:nfs-config/index.html["使用命令行界面概述 NFS 配置"]
* link:nfs-admin/security-styles-their-effects-concept.html["安全模式及其影响是什么"]
