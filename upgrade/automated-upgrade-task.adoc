...
NOTE: 如果您通过NetApp升级到ONTAP 9.15.1 或更高版本，请按照link:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["NetApp控制台文档中的升级过程"^]。
...
+
<<<<<<< HEAD 对于匿名 FTP，您必须以 +ftp://anonymous@ftpserver+ 格式指定 URL。



[]
=====
对于匿名 FTP，您必须以 \ftp://anonymous@ftpserver 格式指定 URL。>>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
