...
要开始使用、您应该 link:prepare.html["准备升级"]。如果您拥有有效的Active IQ数字顾问SupportEdge合同、则应这样做 link:create-upgrade-plan.html["使用Upgrade Advisor规划升级"]。Upgrade Advisor提供的智能信息可帮助您评估集群并创建特定于您的配置的升级计划、从而最大程度地降低不确定性和风险。
