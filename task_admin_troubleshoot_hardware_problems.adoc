...
---
= 使用 ONTAP System Manager 解决硬件问题
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.2+| 平台 11+| 在ONTAP版本的System Manager中受支持... 


| 9.18.1 | 9.17.1 | 9.16.1 | 9.15.1. | 9.14.1. | 9.13.1. | 9.12.1. | 9.11.1. | 9.10.1. | 9.9.1. | 9.8 (仅限预览模式) 
...
| ONTAP 9.10.1 和 9.9.1 | Cisco Nexus 3232C
