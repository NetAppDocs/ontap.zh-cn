...
.关于此任务
此程序适用于 link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF， ASA FAS"^] 和 link:https://docs.netapp.com/us-en/ontap-afx/index.html["AFX 系统"^]。如果您拥有ASA r2 系统（ASA A1K、 ASA A90、 ASA A70、 ASA A50、 ASA A30、 ASA A20 或ASA C30），请按以下步骤操作。 link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["这些步骤"^] 使用系统管理器设置ONTAP集群。ASA r2 系统为仅使用 SAN 的客户提供简化的ONTAP体验。
