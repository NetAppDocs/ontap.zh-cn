...
* 最佳实践： * 如果您的 FAS2720 包含 24 个或更少的 NL-SAS 驱动器，则应验证存储配置默认值是否设置为主动 / 被动以优化性能。
有关详细信息，请参见 link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/GUID-4AC35094-4077-4F1E-8D6E-82BF111354B0.html?cp=4_5_5_11["在使用根数据分区的节点上设置主动 - 被动配置"]
