...
* link:../data-protection/restore-contents-volume-snapshot-task.html["从快照恢复(System Manager)"]
* link:../data-protection/restore-contents-volume-snapshot-task.html["从快照还原文件(命令行界面)"]
