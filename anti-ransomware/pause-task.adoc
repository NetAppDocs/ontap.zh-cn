...
NOTE: 从ONTAP 9.13.1 开始，如果您使用 MAV 来保护 ARP 设置，则暂停操作会提示您获得一个或多个其他管理员的批准。link:../multi-admin-verify/request-operation-task.html["必须获得所有管理员的批准"]与 MAV 审批小组相关，否则操作将会失败。
...
. 如果您使用 MAV（从ONTAP 9.13.1 开始与 ARP 一起使用）来保护 ARP 设置，则暂停操作会提示您获得一个或多个其他管理员的批准。必须获得与 MAV 审批组相关的所有管理员的批准，否则操作将失败。
+
