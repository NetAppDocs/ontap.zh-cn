...
summary: 通过独立于 ONTAP 发布节奏自动或手动更新 ARP/AI 安全捆绑包，使 ARP/AI 防护保持最新状态，以应对最新的勒索软件威胁。 
---
...
NOTE: ARP（ONTAP 9.10.1 至 9.15.1）不支持自动安全模型更新。安全检测功能仅通过 ONTAP 软件升级进行更新。如果您运行的是 ONTAP 9.15.1 或更早版本，请参阅 link:index.html["了解自主勒索软件防护"]。
...
NOTE: 请确保仅安装比当前版本更新的 ARP/AI 更新，以避免任何意外的 ARP/AI 降级。
...
.相关信息
* link:learn-about-arpai.html["了解ARP/AI"]
