...
+
如果您需要在AFF系统上增加容量、在非AF系统上使用Amazon S3或从现有集群升级、则需要 link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html["FabricPool 许可证"]。
