...
* 分层到 Alibaba Cloud Object Storage 时需要 link:https://console.netapp.com/cloud-tiering["NetApp Cloud Tiering 许可证"^]。有关详细信息，请参见 link:install-license-aws-azure-ibm-task.html["在ONTAP集群上安装FabricPool许可证"]。
