...
link:tiering-policies-concept.html#what-happens-when-you-modify-a-volume-tiering-policy["修改卷分层策略时会发生什么"]
...
** `none`
+
link:tiering-policies-concept.html["FabricPool 卷分层策略"]
