...
+
新订购的 AFF 系统附带了 10 TB 的可用容量，可用于使用 FabricPool 。如果您需要AFF系统上的额外容量、在非AFF系统上使用IBM云对象存储或从现有集群升级，则需要link:../fabricpool/install-license-aws-azure-ibm-task.html["FabricPool 许可证"]。
