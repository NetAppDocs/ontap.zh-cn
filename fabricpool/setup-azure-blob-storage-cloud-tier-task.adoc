...
* 从本地 ONTAP 群集分层到 Azure Blob Storage 时需要 link:install-license-aws-azure-ibm-task.html["FabricPool 许可证"]。
* 如果您从 Cloud Volumes ONTAP 或 Azure NetApp Files 使用 Azure Blob 存储，则无需许可证。
