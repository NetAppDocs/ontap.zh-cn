...
====
您可以使用[`volume object-store tiering show`命令查看FabricPool卷的层状态。有关链接：https://docs．．NetApp ONTAP－CLI//volume-object-store-tiering-show.html命令的更多信息，请[`volume object-store tiering show`参阅ONTAP命令参考。
