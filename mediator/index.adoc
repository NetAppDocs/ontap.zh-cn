...
* 您必须根据 Red Hat 最佳实践安装 Red Hat Enterprise Linux 或 CentOS 。由于 CentOS 8.x 版本的支持已停止使用，因此不建议使用 RHEL 或兼容的 CentOS 7.x 版本
...
* 要使用 SnapMirror 业务连续性，请参见 xref:../smbc/smbc_install_confirm_ontap_cluster.html[安装 ONTAP 调解器服务并确认 ONTAP 集群配置]
