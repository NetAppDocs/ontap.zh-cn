...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["两个"]link:upgrade-host-os-mediator-task.html["升级主机操作系统和 Mediator"]
[role="quick-margin-para"]
如果要升级现有版本的 ONTAP Mediator，则必须先卸载以前的版本，然后安装新版本。如果您是首次安装 ONTAP Mediator，则可以跳过此步骤。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["六个"]link:install-mediator-pkg-task.html["安装 ONTAP Mediator"]
[role="quick-margin-para"]
