...
+
或者，您可以在 `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` 命令中使用 `--https-only` 选项来仅指定 HTTPS。
...
[NOTE]
====
要在安装过程中跳过签名检查，请使用以下命令： `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
