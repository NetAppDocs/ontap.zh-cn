...
[NOTE]
====
* 在ONTAP调解器1.8及更早版本中，使用的CA文件包括： `ca.key`、 `ca.csr`、 `ca.srl`和 `ca.crt`。从ONTAP调解器1.9开始，所需的文件为 `intermediate.key`、 `intermediate.csr`、 `intermediate.srl`和 `intermediate.crt`。
