...
.相关信息
有关 ONTAP 技术和与外部服务交互的其他信息，请参见这些技术报告 (TR)：** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["NetApp 技术报告 4172 ：《基于 SMB 3.0 的 Microsoft Hyper-V 与 ONTAP 最佳实践》"^]
