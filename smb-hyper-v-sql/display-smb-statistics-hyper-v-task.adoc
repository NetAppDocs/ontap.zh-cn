...
* link:https://docs.netapp.com/us-en/ontap-cli-9121/statistics-start.html["统计信息启动"^]
* link:https://docs.netapp.com/us-en/ontap-cli-9121/statistics-stop.html["统计信息停止"^]
