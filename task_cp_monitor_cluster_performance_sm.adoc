...
.关于此任务
此过程适用于FAS、AFF和当前ASA系统。如果您使用的是ASA R2系统(ASA A1K、ASA A70或ASA A90)、请按照link:https://docs.netapp.com/us-en/asa-r2/monitor/monitor-performance.html["这些步骤"^]监控集群性能。ASA R2系统可为仅使用SAN的客户提供简化的ONTAP体验。
