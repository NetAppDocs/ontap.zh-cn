...
---
= 了解如何使用 ONTAP System Manager 监控集群性能
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
从 ONTAP 9.19.1 开始，SVM 管理员可以使用 ONTAP System Manager 中的专用 SVM 管理员仪表板来监控和管理自己的 SVM。有关详细信息，请参见link:task-svm-admin-dashboard-sm.html["使用 System Manager 管理和监控 SVM"]。
