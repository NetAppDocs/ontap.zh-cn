...
+
从ONTAP 9.12.1P2开始，单个FlexGroup卷的最大容量为60 PB，当时，10节点集群上的文件数为4000亿link:../volumes/enable-large-vol-file-support-task.html["已启用大卷支持"]。如果不支持大型卷、则一个FlexGroup卷的最大容量为20 PB。
