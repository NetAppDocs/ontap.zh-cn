...
== ONTAP 9.18.1 及更高版本支持的功能

* xref:../performance-admin/adaptive-qos-policy-groups-task.html[嵌套 QoS 策略]支持以下对象对：
+
** SVM 和FlexGroup卷包含在 SVM 中
** FlexGroup卷和卷内的 qtree
...
* xref:../anti-ransomware/index.html[自主勒索软件保护] 适用于 FlexGroup 卷，包括以下支持的功能：
+
