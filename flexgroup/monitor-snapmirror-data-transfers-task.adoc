...
----
. 查看FlexGroup卷中每个成分卷的SnapMirror关系状态： `snapmirror show -expand`
+
[listing]
----
...
...
----
. 如果SnapMirror传输失败、请确定传输失败的FlexGroup卷成分卷以及出现错误的原因： `snapmirror show -fields last-transfer-error -expand`
+
[listing]
----
