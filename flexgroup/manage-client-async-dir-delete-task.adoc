...
link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously["了解如何使用 ONTAP 从 FlexVol 和 FlexGroup 卷异步删除目录"].
...
.步骤
. 从集群 CLI 进入高级权限模式： `-privilege advanced`
