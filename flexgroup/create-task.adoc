...
* 当您使用系统管理器创建FlexGroup卷时， ONTAP会自动选择创建FlexGroup卷所需的本地层。
...
====
.相关信息
https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp 技术报告 4571 ：《 NetApp FlexGroup 最佳实践和实施指南》"^]
