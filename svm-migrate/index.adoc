...
* 源集群和目标集群必须同步SnapMirror link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["已安装许可证"]。此许可证包含在中 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"]。
...
| SnapMirror云关系 | ONTAP 9.12.1 | 从ONTAP 9.12.1开始、在迁移具有SnapMirror云关系的SVM时、目标集群必须具有 link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["SnapMirror Cloud 许可证"] 并且它必须具有足够的可用容量、以支持将要镜像到云的卷中的容量移动。 
