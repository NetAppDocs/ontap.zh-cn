...
image:workflow_svm_migrate.gif["SVM 迁移工作流"]
...
| SnapMirror云关系 | ONTAP 9.12.1 | 从ONTAP 9.12.1开始、在迁移具有SnapMirror云关系的SVM时、目标集群必须具有 link:../data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["SnapMirror Cloud 许可证"] 并且它必须具有足够的可用容量、以支持将要镜像到云的卷中的容量移动。 
