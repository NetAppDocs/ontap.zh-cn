...
summary: '您可以使用System Manager安装NetApp许可证文件和许可证密钥(这是安装NLFS的首选方法)、也可以使用ONTAP命令行界面安装许可证密钥。在ONTAP 9.10.1及更高版本中、使用NetApp许可证文件(NLL)启用功能；在ONTAP 9.10.1之前的版本中、使用许可证密钥启用ONTAP功能。 ' 
---
= 安装ONTAP许可证
:allow-uri-read: 
:icons: font
...
[role="lead"]
您可以使用System Manager安装NetApp许可证文件和许可证密钥(这是安装NLFS的首选方法)、也可以使用ONTAP命令行界面安装许可证密钥。在ONTAP 9.10.1及更高版本中、使用NetApp许可证文件(NLL)启用功能；在ONTAP 9.10.1之前的版本中、使用许可证密钥启用ONTAP功能。

.步骤
如果您已下载NetApp许可证文件或许可证密钥、则可以使用System Manager或ONTAP命令行界面安装NLFS和28个字符的许可证密钥。
