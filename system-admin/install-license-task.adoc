...
summary: 您可以使用 System Manager 安装 NetApp 许可证文件和许可证密钥，这是安装 NLF 的首选方法，也可以使用 ONTAP CLI 安装许可证密钥。在 ONTAP 9.10.1 及更高版本中，使用 NetApp 许可证文件启用功能，在早于 ONTAP 9.10.1 的版本中，使用许可证密钥启用 ONTAP 功能。 
---
= 在ONTAP中安装NetApp许可证
:allow-uri-read: 
:icons: font
