...
====
如果要禁用AutoSupport OnDemand但保持启用AutoSupport、请使用以下命令：link：https://docs NetApp．ONTAP－AutoSupport－MODIY.html#parameters ^。[`system node autosupport modify -ondemand-state disable`
