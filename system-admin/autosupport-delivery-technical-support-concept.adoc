...
====
如果要禁用AutoSupport OnDemand、但保持启用AutoSupport 、请使用命令： link:https://docs.netapp.com/us-en/ontap-cli-95/system-node-autosupport-modify.html#parameters["06502a0599b03511ba3f6a4dcdcbba45"]。
