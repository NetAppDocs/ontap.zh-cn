...
.步骤
您可以为具有现有 NetApp 许可证文件捆绑包的系统以及具有已在运行 ONTAP 9.10.1 及更高版本的系统上转换为 NetApp 许可证文件的 28 字符许可证密钥的系统下载 ONTAP One 许可证文件。您还可以付费将系统从 ONTAP Base 升级到 ONTAP One。有关下载 NetApp 许可证文件的详细信息，请参见知识库文章 link:https://kb.netapp.com/nss/Licensing/How_to_download_NLF_licenses_from_the_NetApp_Support_Site["如何从 NetApp 支持站点下载 NLF 许可证"^]。
