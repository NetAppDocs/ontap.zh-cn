...
summary: 单节点集群是在独立节点上运行的集群的特殊实现。不建议使用单节点集群，因为它们不提供冗余。如果节点关闭，数据访问将丢失。 
---
= 管理单节点ONTAP集群
:allow-uri-read: 
:icons: font
...
.相关信息
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["NetApp技术报告4684:《使用NVMe-oF实施和配置现代SAN》"^]
