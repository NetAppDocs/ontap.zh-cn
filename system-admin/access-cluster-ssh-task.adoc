...
+
 `-application`命令的参数[`security login`用于指定用户帐户的访问方法。有关链接：https://docs．．NetApp ONTAP－CLI/secure-login-create.html#DESCRIPTION ]命令的详细信息[`security login`，请参阅ONTAP命令参考。
