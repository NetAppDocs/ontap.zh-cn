...
summary: 成功测试 NFS 客户端访问后，可以执行其他 NFS 配置或添加 SAN 访问。协议访问完成后，应保护 Storage Virtual Machine 的根卷。 
---
...
* https://www.netapp.com/pdf.html?item=/media/16398-tr-3580.pdf["NetApp 技术报告 3580 ：《 NFSv4 增强功能和最佳实践指南： Data ONTAP 实施》"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16885-tr-4182.pdf["NetApp 技术报告 4182 ：《集群模式 Data ONTAP 配置的以太网存储设计注意事项和最佳实践》"^]
+
