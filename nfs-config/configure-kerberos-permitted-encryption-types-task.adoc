...
summary: 默认情况下， ONTAP 支持 NFS Kerberos 的以下加密类型 - DES 、 3DES 、 AES-128 和 AES-256 。您可以使用带有 -permitted-enc-types 参数的 vserver nfs modify 命令，为每个 SVM 配置允许的加密类型，以满足特定环境的安全要求。 
---
