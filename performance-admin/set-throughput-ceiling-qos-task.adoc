...
link:guarantee-throughput-qos-task.html["详细了解吞吐量上限"].
...
+
如需了解更多信息  `qos statistics workload latency show`，请参阅 link:https://docs.netapp.com/us-en/ontap-cli/qos-statistics-workload-latency-show.html["ONTAP 命令参考"^]。
