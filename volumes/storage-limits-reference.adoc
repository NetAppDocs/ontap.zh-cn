...
. 在**产品**下拉菜单中，选择您的硬件配置。
+
image:hardware-universe-products.png["Hardware Universe产品菜单"]

. 选择您的平台。
+
image:hardware-universe-platforms.png["Hardware Universe平台菜单"]

. 选择适当版本的ONTAP，然后**显示结果**。
+
image:hardware-universe-os-filter.png["Hardware Universe OS筛选器菜单"]
