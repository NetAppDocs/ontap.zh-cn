...
* 如果要将FabricPool优化卷从ONTAP 9.13.1 或更早版本移动到ONTAP 9.15.1 或更高版本，请参阅link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/FS_Issues/CONTAP-307878["NetApp知识库：CONTAP-307878 - 如果源ONTAP小于 9.14.1 且目标大于 9.14.1，则在FabricPool优化卷移动期间发生意外重启"^]。
* 从ONTAP 9.15.1 开始，将卷从 A400 系统移动到 A70、A90 或 A1K 系统可能会导致读取延迟问题增加。有关详细信息和建议措施，请参阅 link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/FS_Issues/CONTAP-556247["NetApp知识库：CONTAP-556247 - 卷从 A400 迁移到 A70、A90 和 A1K 后压缩/解压缩速度缓慢"^]。
