...
NOTE: 此过程适用于FAS、AFF和当前ASA系统。如果您有ASA R2系统(ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30或ASA A20)、请按照link:https://docs.netapp.com/us-en/asa-r2/administer/reboot-take-over-give-back-nodes.html["这些步骤"^]关闭并重新启动节点。ASA R2系统可为仅使用SAN的客户提供简化的ONTAP体验。
