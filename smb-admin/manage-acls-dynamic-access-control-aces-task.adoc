...
summary: 如果您的资源具有与 Dynamic Access Control ACE 一起应用的 ACL，并且您在存储虚拟机上禁用了 Dynamic Access Control，则必须先删除 Dynamic Access Control ACE，然后才能管理该资源上的非 Dynamic Access Control ACE。 
---
