...
如果您使用的是ONTAP 9.7或更早版本中的System Manager、请参见 link:https://docs.netapp.com/us-en/ontap-sm-classic/online-help-96-97/concept_managing_data_protection.html["管理数据保护"^]
