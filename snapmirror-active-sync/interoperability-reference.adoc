...
从 ONTAP 9.19.1 开始，ARP/AI 支持参与 SnapMirror 活动同步 SAN 关系的主卷。有关详细信息，请参见link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["自主勒索软件保护使用情形和注意事项"]。
