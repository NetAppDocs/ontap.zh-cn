...
在非对称主动/被动配置中，辅助站点上的数据将代理到 LUN、命名空间或存储单元。
...
从 ONTAP 9.15.1 开始，SnapMirror 主动同步支持主优先和主偏好。主副本在 System Manager 中指定，并通过 ONTAP REST API 和 ONTAP CLI 输出。
...
NOTE: 非对称主动/被动不支持 ASA r2 和 NVMe。有关 NVMe 支持的详细信息，请参见 link:../nvme/support-limitations.html["NVMe配置、支持和限制"]。
...
* FC
 ...
 a| 
* 非对称主动/被动
* 对称主动/主动对称主动/主动配置在 ONTAP 9.16.1 及更高版本中支持 4 节点到 4 节点集群。对于 ASA r2，仅支持 2 节点集群。
...
* FC
 ...
 a| 
* 非对称主动/被动
* 对称主动/主动对称主动/主动配置支持 ONTAP 9.15.1 中的 2 节点集群。ONTAP 9.16.1 及更高版本支持 2 节点到 2 节点集群和 4 节点到 4 节点集群。
