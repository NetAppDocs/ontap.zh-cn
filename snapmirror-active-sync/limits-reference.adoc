...
IMPORTANT: 这些限制适用于 AFF 和 ASA 系统。如果您有 ASA r2 系统（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30 或 ASA A20），请参阅 link:https://docs.netapp.com/us-en/asa-r2/data-protection/manage-consistency-groups.html["ASA R2文档"^]。
