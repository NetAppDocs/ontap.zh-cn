...
[role="lead"]
从ONTAP 9.4开始、非MetroCluster AFF 配置支持NVMe/FC。从ONTAP 9.9.1开始、所有非MetroCluster全SAN阵列(ASA)配置也支持NVMe/FC。
...
* link:san-admin/map-nvme-namespace-subsystem-task.html["将 NVMe 命名空间映射到子系统"]
