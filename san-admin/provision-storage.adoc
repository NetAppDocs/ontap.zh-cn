...
要使用System Manager Classic (9.7及更早版本提供)完成此任务、请参见 https://["适用于 Red Hat Enterprise Linux 的 iSCSI 配置"^]
...
https://["在System Manager中查看和管理SAN启动程序组"]
http://["NetApp 技术报告 4017 ：《光纤通道 SAN 最佳实践》"]
