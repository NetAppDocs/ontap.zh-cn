...
. 选择 *Save。*
. 将目标端口的电缆直接连接到主机启动器。
. 如果您有 AFF、ASA 或 FAS 系统，请按照以下步骤创建 LIF：如果您有 ASA r2 系统，请按照link:https://docs.netapp.com/us-en/asa-r2/administer/manage-client-vm-access.html#create-a-lif-network-interface["此 System Manager 过程"^]创建 LIF。
+
