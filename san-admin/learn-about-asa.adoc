...
summary: NetApp 全闪存 SAN 阵列从 ONTAP 9.7 开始提供。ASA 是基于经过验证的 AFF NetApp 平台构建的全闪存仅限 SAN 的解决方案。 
---
= 了解全闪存SAN阵列配置
:hardbreaks:
:toclevels: 1
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["NetApp技术报告4080：《现代SAN的最佳实践》"^]
