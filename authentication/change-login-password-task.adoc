...
NOTE: 您可以使用 `security login role config modify` 命令以修改与给定角色关联的帐户的密码规则。有关详细信息，请参见 link:https://docs.netapp.com/us-en/ontap-cli-9131/security-login-role-config-modify.html["命令参考"^]。
