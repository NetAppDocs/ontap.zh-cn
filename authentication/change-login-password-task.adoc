...
NOTE: 您可以使用[`security login role config modify`命令修改与给定角色关联的帐户的密码规则。有关链接：https://docs NetApp．ONTAP－CLI/security-login-role-config-modify.html^的更多信息，请[`security login role config modify`参阅ONTAP命令参考。
