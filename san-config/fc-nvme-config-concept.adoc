...
* 从ONTAP 9.11.1开始、支持使用NVMe的集群最多包含12个节点。从ONTAP 9.4开始、NVMe最多支持4个节点的集群。
...
请参见 https://["NetApp Hardware Universe"^] 有关 NVMe 限制的完整列表。

.相关信息
https://["如何配置 SUSE Enterprise Linux 和 ONTAP NVMe/FC 命名空间并将其连接起来"]

https://["ONTAP 上 NVMe 协议的许可信息"]
