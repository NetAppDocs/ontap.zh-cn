...
NOTE: 这些限制适用于当前的ASA系统。如果您有 ASA r2 系统（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30、ASA A20 或 ASA C30），请参阅link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA R2系统存储限制"] 。
