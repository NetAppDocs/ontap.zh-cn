...
NOTE: 这些限制适用于 ASA 系统。如果您有 ASA r2 系统（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30、ASA A20 或 ASA C30），请参阅 link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA R2系统存储限制"^]。
...
有关永久端口的详细信息，请参见 link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["NetApp技术报告4080：《现代SAN的最佳实践》"^]。
