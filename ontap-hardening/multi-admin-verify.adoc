...
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/manage-groups-task.html["创建一个或多个管理员批准组。"]
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/enable-disable-task.html["启用多管理员验证功能。"]
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/manage-rules-task.html["添加或修改规则。"]
...
. 当用户启动操作时、将显示 link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/request-operation-task.html["已生成请求。"]
. 在执行之前、需要指定的数量 link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/manage-requests-task.html["MAV管理员必须批准。"]
. 批准后、用户完成操作。
