...
| SnapMirror业务连续性(SM-BC)增强功能  a| 
* link:../smbc/smbc_admin_add_and_remove_volumes_in_consistency_groups.html["无干扰地将卷添加到具有活动SM-BC关系的一致性组。"]
* link:../smbc/supported-configurations-reference.html#ndmp-restore["利用SM-BC的NDMP还原"]。
...
* xref:../use-cases-restrictions-concept.html#multi-admin-verification-with-volumes-protected-with-arp[多管理员验证功能、具有自主防兰软件保护功能]
