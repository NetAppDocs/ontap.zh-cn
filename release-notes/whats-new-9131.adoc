...
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[多管理员验证功能、具有自主防兰软件保护功能]
...
从ONTAP 9.12.1 开始，系统管理器与NetApp控制台集成。详细了解xref:../concepts/sysmgr-integration-console-concept.html[System Manager 与NetApp Console 集成] 。
