...
| 更新 | Description 
 ...
 a| 
xref:../anti-ransomware/index.html[其他虚拟机监控程序支持]
 a| 
从 ONTAP 9.17.1P5 开始，Autonomous Ransomware Protection 支持 Hyper-V、KVM 和 OpenStack 虚拟机管理程序。



 a| 
xref:../anti-ransomware/index.html[自动勒索软件防护快照更新]
 a| 
ONTAP 对 ARP/AI 快照进行了多项更新。
