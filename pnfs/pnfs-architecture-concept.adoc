...
NOTE: 在这些命令中，卷名不存在。而是使用与这些卷关联的数字 ID：MSID 和 DSID。要查找与映射关联的卷，您可以在 ONTAP CLI 的高级权限中使用 `volume show -dsid [dsid_numeric]`或 `volume show -msid [msid_numeric]`。
...
* https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp技术报告 4571： FlexGroup最佳实践"^]
