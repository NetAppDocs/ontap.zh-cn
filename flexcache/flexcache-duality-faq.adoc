...
标准 S3 NAS 存储区上支持的 S3 操作在 FlexCache S3 NAS 存储区上受支持，但  `COPY` 操作除外。有关标准 S3 NAS 存储区不支持的操作的最新列表，请访问 link:../s3-multiprotocol/index.html#s3-and-nas-interoperability["互操作性文档"]。
