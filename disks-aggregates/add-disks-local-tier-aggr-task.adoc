...
只有在安装了 ONTAP 9.8 或更高版本的情况下，才能执行此任务。如果您安装的是早期版本的 ONTAP ，请参见 ,使用System Manager添加容量(ONTAP 9.7或更早版本)。
...
只有在安装了 ONTAP 9.7 或更早版本的情况下，才能执行此任务。如果您安装的是 ONTAP 9.8 或更高版本，请参见 ,使用System Manager添加容量(ONTAP 9.8或更高版本)。
