...
.关于此任务
此过程适用于FAS、AFF和当前ASA系统。如果您有ASA R2系统(ASA A1K、ASA A70或ASA A90)、请按照link:https://docs.netapp.com/us-en/asa-r2/data-protection/snapshot-replication.html["这些步骤"^]创建设置Snapshot复制。ASA R2系统可为仅使用SAN的客户提供简化的ONTAP体验。
