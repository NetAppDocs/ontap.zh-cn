...
summary: 创建子网以分配或保留用于 ONTAP 网络配置的特定 IP 地址块。 
---
= 为ONTAP网络创建子网
:hardbreaks:
:allow-uri-read: 
...
有关的详细信息 `network subnet rename`，请参见link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-rename.html["ONTAP 命令参考"^]。
