...
有关此命令的详细信息，请参见 link:http://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-clients.html["ONTAP 命令参考"^]。
...
有关此命令的详细信息、请参见手册页： https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html["ONTAP 命令参考"^]
