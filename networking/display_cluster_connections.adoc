...
summary: 按客户端、LIF、协议或服务查看集群中的所有活动或侦听连接，或查看节点上的活动连接计数。 
---
= 查看ONTAP集群连接
:hardbreaks:
:allow-uri-read: 
...
如需了解有关 `network connections active show-protocols`的更多信息，请参阅link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols["ONTAP 命令参考"^]。
