...
DSCP 标记（也称为 _qos marks_ 或 _quality of service marks_ ）可通过提供 IP 空间，协议和 DSCP 值来启用。可以应用 DSCP 标记的协议包括 NFS ， CIFS ， iSCSI ， SnapMirror ， NDMP ， FTP ， HTTP/HTTPS ， SSH ， Telnet 和 SNMP 。
