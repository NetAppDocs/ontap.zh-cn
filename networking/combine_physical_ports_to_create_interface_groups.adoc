...
有关的详细信息 `network port ifgrp add-port`，请参见link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["ONTAP 命令参考"^]。有关的详细信息 `network port ifgrp add-port`，请参见link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["ONTAP 命令参考"^]。
...
有关的详细信息 `network port ifgrp delete`，请参见link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["ONTAP 命令参考"^]。有关的详细信息 `network port ifgrp delete`，请参见link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["ONTAP 命令参考"^]。
