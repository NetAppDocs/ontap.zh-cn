...
|===
了解有关此过程中所述的命令的link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-remove-ranges.html["网络子网删除范围"^]更多信息link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-add-ranges.html["网络子网添加范围"^]。
